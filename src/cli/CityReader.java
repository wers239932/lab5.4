...
public class CityReader {
    public static City readCity(LineReader lineReader, Terminal terminal) throws IOException {
        ...
        return new City(name,new Coordinates(x,y),area,population,deep,capital,carcode,government, governor);
    }
}
